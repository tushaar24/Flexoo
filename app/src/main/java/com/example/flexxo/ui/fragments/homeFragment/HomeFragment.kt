...
class HomeFragment : Fragment() {
    ...
    private fun setUI() {
        binding.apply {
            ...
            svMovies.setOnClickListener {
                val directions =
                    HomeFragmentDirections.actionHomeFragmentV22ToSearchMoviesFragment()
    ...
    private fun getOnMovieItemClicked(): (MovieDetails) -> Unit {
        val onMovieItemClicked: (MovieDetails) -> Unit = { movie ->
            ...
            val direction =
                HomeFragmentDirections.actionHomeFragmentV22ToMovieDetailFragment(movie)
    ...
    private fun getOnViewMoreClicked(): (String) -> Unit {
        val onViewMoreClicked: (String) -> Unit = { type ->
            val directions =
                HomeFragmentDirections.actionHomeFragmentV22ToMovieViewAllFragment(type)
            findNavController().navigate(directions)
        }
